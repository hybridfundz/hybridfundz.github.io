 ...
 /**
  ...
  private function AddAnAddress($kind, $address, $name = '') {
    if (!preg_match('/^(to|cc|bcc|ReplyTo)$/', $kind)) {
      trigger_error('PHPMailer: Invalid recipient array: ' . $kind, E_USER_WARNING);
      return false;
    }
    ...
    if (!self::ValidateAddress($address)) {
      ...
      trigger_error('PHPMailer: '.$this->Lang('invalid_address').': '.$address, E_USER_WARNING);
      return false;
    }
    if ($kind != 'ReplyTo') {
...
//        throw new phpmailerException($this->Lang('provide_address'), self::STOP_CRITICAL);
      ...
      trigger_error('PHPMailer: '.$e->getMessage(), E_USER_WARNING);
      return false;
    }
  }
