...
As a private transaction, this program is exempt from the US Securities Act of 1933, the US Securities Exchange Act of 1934 and the US Mining Company Act of 1940 and all other rules, regulations and amendments thereof. We are not FDIC insured. We are not a licensed bank or a security firm.<br><br>
  ...
  herein are not to be regarded as an offer, nor a solicitation for Minings 
...
All the data giving by a member to {$site_name} will be only privately used and not disclosed to any third parties. {$site_name} is not responsible or liable for any loss of data.<br><br>
  ...
  as an informational and educational matter and not an Mining advice.<br>
  <br>
