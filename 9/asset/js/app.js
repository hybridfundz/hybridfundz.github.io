...
! function(t) {
    ...
    SAASONE.initialize = {
        init: function() {
            SAASONE.initialize.general(), 
            SAASONE.initialize.sectionBackground(), 
            SAASONE.initialize.sectionSwitch(), 
            SAASONE.initialize.portfolio(), 
            SAASONE.initialize.countUp(), 
            SAASONE.initialize.swiperSlider(), 
            SAASONE.initialize.googleMap(), 
            SAASONE.initialize.contactFrom()
        },
        general: function() {
            new WOW({
                boxClass: "wow",
            ...
            }).init(), t("body").on("contextmenu", function(t) {
            ...
            }), t("#sone-tabs-nav li:nth-child(2)").addClass("active"), t("#sone-tabs-content .content").hide(), t("#sone-tabs-content .content:nth-child(2)").show(), t("#sone-tabs-nav li").on("click", function() {
                t("#sone-tabs-nav li").removeClass("active"), t(this).addClass("active"), t("#sone-tabs-content .content").hide();
        ...
        portfolio: function() {
            if (void 0 !== t.fn.imagesLoaded && void 0 !== t.fn.isotope) {
                t(".saasone-portfolio-items").imagesLoaded(function() {
                    var i = t(".saasone-portfolio-items");
                    i.isotope({
                        itemSelector: ".saasone-portfolio-item",
                        percentPosition: !0,
                    ...
                    }), t(".saasone-isotope-filter a").on("click", function() {
                        t(".saasone-isotope-filter").find(".current").removeClass("current"), t(this).parent().addClass("current");
        ...
        mobileMenu: function() {
            t(window).width() < 991 && (t(".navbar li.active").addClass("open").children("ul").show(), t(".navbar li.menu-item-has-children>a").on("click", function() {
    ...
    }, SAASONE.documentOnReady = {
        init: function() {
            SAASONE.initialize.init()
        }
    }, SAASONE.documentOnLoad = {
        init: function() {
            t(".page-loader").fadeOut("slow")
        }
    }, SAASONE.documentOnResize = {
        init: function() {}
    }, SAASONE.documentOnScroll = {
        init: function() {
            SAASONE.initialize.sectionBackground(), t(window).scrollTop() > 300 ? t(".return-to-top").addClass("back-top") : t(".return-to-top").removeClass("back-top")
        }
    }, t(document).ready(SAASONE.documentOnReady.init), t(window).on("load", SAASONE.documentOnLoad.init), t(window).on("resize", SAASONE.documentOnResize.init), t(window).on("scroll", SAASONE.documentOnScroll.init)
}(jQuery);
