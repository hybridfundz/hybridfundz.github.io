...
<DIV style="LEFT: 400px; WIDTH: 450px; POSITION: absolute; TOP: 7px; HEIGHT: 20px"  align="center">
  ...
  <tr> 
    <td valign=top>
      <table cellspacing=0 cellpadding=0 border=0 width=758>
	    <tr >
		  <td bgcolor=#8BB0C0><img src="images/back.jpg" border=0 alt="" width=780 height=150></td>
           </tr>
      </table>
    </td>
  </tr>
