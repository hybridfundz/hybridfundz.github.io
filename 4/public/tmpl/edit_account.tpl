...
<tr>
 <td>e-gold acc no:</td>
 <td>{if $settings.usercanchangeegoldacc == 1}<input type=text name=egold_account value='{$userinfo.egold_account|escape:"quotes"}' class=inpts size=30>{else}{$userinfo.egold_account}{/if}</td>
</tr>
{/if}
{if $settings.def_payee_account_evocash}
<tr>
 <td>Evocash acc no:</td>
 <td><input type=text name=evocash_account value='{$userinfo.evocash_account|escape:"quotes"}' class=inpts size=30></td>
</tr>
{/if}
<tr>
{if $settings.def_payee_account_intgold}
 <td>INTGold acc no:</td>
 <td><input type=text name=intgold_account value='{$userinfo.intgold_account|escape:"quotes"}' class=inpts size=30></td>
</tr>
{/if}
{if $settings.def_payee_account_stormpay}
<tr>
 <td>StormPay acc:</td>
 <td><input type=text name=stormpay_account value='{$userinfo.stormpay_account|escape:"quotes"}' class=inpts size=30></td>
</tr>
{/if}
{if $settings.def_payee_account_ebullion}
<tr>
 <td>e-Bullion acc:</td>
 <td><input type=text name=ebullion_account value='{$userinfo.ebullion_account|escape:"quotes"}' class=inpts size=30></td>
</tr>
{/if}
{if $settings.def_payee_account_paypal}
<tr>
 <td>PayPal acc:</td>
 <td><input type=text name=paypal_account value='{$userinfo.paypal_account|escape:"quotes"}' class=inpts size=30></td>
</tr>
{/if}
{if $settings.def_payee_account_goldmoney}
<tr>
 <td>GoldMoney acc:</td>
 <td><input type=text name=goldmoney_account value='{$userinfo.goldmoney_account|escape:"quotes"}' class=inpts size=30></td>
</tr>
{/if}
{if $settings.def_payee_account_eeecurrency}
<tr>
 <td>eeeCurrency acc:</td>
 <td><input type=text name=eeecurrency_account value='{$userinfo.eeecurrency_account|escape:"quotes"}' class=inpts size=30></td>
</tr>
{/if}
<tr>
