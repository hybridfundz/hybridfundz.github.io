...
<div class="statistContainer">
  <div class="statistInner zoomIn wow">
    ...
    <div class="statist-part statist-part2">
      <h3>{$settings.info_box_total_accounts_generated + 23402}</h3>
      <p>Total Members</p>
    </div>
    <div class="statist-part statist-part3">
      <h3>{$currency_sign} {$settings.info_box_today_deposit_funds_generated + 95902832}</h3>
      <p>Total Deposits</p>
    </div>
    <div class="statist-part statist-part4">
      <h3>{$currency_sign} {$settings.info_box_withdraw_funds_generated + 705834239}</h3>
