<?php /* Smarty version 3.1.27, created on 2022-10-07 00:05:14
         compiled from "/home/u653868903/domains/hybridminers.io/public_html/tmpl/home.tpl" */ ?>
<?php
/*%%SmartyHeaderCode:743278028633f6d3a094ff3_64708927%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2c43fb62ae4b5f57deec5cde8f217c74d581e712' => 
    array (
      0 => '/home/u653868903/domains/hybridminers.io/public_html/tmpl/home.tpl',
      1 => 1664314955,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '743278028633f6d3a094ff3_64708927',
  'variables' => 
  array (
    'plans' => 0,
    'plan' => 0,
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_633f6d3a0a1552_88723267',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_633f6d3a0a1552_88723267')) {
function content_633f6d3a0a1552_88723267 ($_smarty_tpl) {
...
$_smarty_tpl->properties['nocache_hash'] = '743278028633f6d3a094ff3_64708927';
?>
<!doctype html>
<html lang="en">
...
<head>
    ...
    <title> Hybridminers -  Investment </title>
    <!-- CSS only -->
                ...
                <div class="container">
                    <nav class="navbar navbar-expand-xl p-0 align-items-center">
                        ...
                        <ul class="account-menu mobile-acc-menu">
                            <li class="icon">
                                <a href="?a=login"><i class="las la-user"></i></a>
                            </li>
                        </ul>
...
>
                ...
                <div class="row">
                    <div class="col-xl-5 col-lg-8">
                        <div class="hero__content">
                            ...
                            <a href="/?a=login" class="cmn-btn text-uppercase font-weight-600 mt-4">Login</a>
                        </div>
                    </div>
                </div>
            </div>
       ...
       <?php echo '<script'; ?>
 type="text/javascript" src="https://files.coinmarketcap.com/static/widget/coinMarquee.js"><?php echo '</script'; ?>
                    ...
                    <div class="col-lg-6 offset-lg-6">
                        <div class="about-content">
                            ...
                            <p class="mt-4">Our goal is to provide our investors with a reliable source of high income, while minimizing any possible risks and offering a high-quality service, allowing us to automate and simplify the relations between the investors and
                                the trustees. We work towards increasing your profit margin by profitable investment. We look forward to you being part of our community.</p>
                            <a href="/cert.pdf" class="cmn-btn mt-4">Click to reveal Our License</a>
                        </div>
                        <!-- about-content end -->
                    </div>
                </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-6 text-center">
                        <div class="section-header">
                            <h2 class="section-title"><span class="font-weight-normal">How</span> <b class="base--color"> Hybridminers</b> <span class="font-weight-normal">Works</span></h2>
...
?>  
 ...
 <h4 class="package-card__title base--color mb-2"><?php
...
?> <?php echo smarty_modifier_myescape(htmlspecialchars($_smarty_tpl->tpl_vars['plan']->value['name'], ENT_QUOTES, 'UTF-8', true));?>
</h4>
...
?>
            <a href="?a=login" class="cmn-btn btn-md mt-4">Invest Now</a>             
     </div>      
      </div>  <?php
        ...
        <section class="pt-120 pb-120 overlay--radial bg_img" data-background="assets/images/bg/bg-3.jpg">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-6 text-center">
                        <div class="section-header">
                            <h2 class="section-title"><span class="font-weight-normal">Why Choose</span> <b class="base--color"> Hybridminers</b></h2>
        ...
        <section class="pt-120 pb-120 bg_img" data-background="assets/images/bg/bg-5.jpg">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-6 text-center">
                        <div class="section-header">
                            <h2 class="section-title"><span class="font-weight-normal"> Hybridminers</span> <b class="base--color">Trusted</b>by</h2>
                            <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Esse voluptatum eaque earum quos quia? Id aspernatur ratione, voluptas nulla rerum laudantium neque ipsam eaque</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="row justify-content-center mb-none-30">
                    <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
                        <div class="team-card">
                            <div class="team-card__thumb">
                                <img src="assets/images/coin/1.jpg" alt="image">
                            </div>
                            <div class="team-card__content">
                                <h4 class="name mb-1">GEMINI</h4>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
                        <div class="team-card">
                            <div class="team-card__thumb">
                                <img src="assets/images/coin/2.jpg" alt="image">
                            </div>
                            <div class="team-card__content">
                                <h4 class="name mb-1">BLOCKCHAIN.</h4>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
                        <div class="team-card">
                            <div class="team-card__thumb">
                                <img src="assets/images/coin/3.jpg" alt="image">
                            </div>
                            <div class="team-card__content">
                                <h4 class="name mb-1">COINBASE</h4>
                                <span class="designation"></span>
                            </div>
                        </div>
                        <!-- team-card end -->
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
                        <div class="team-card">
                            <div class="team-card__thumb">
                                <img src="assets/images/coin/4.jpg" alt="image">
                            </div>
                            <div class="team-card__content">
                                <h4 class="name mb-1">BINANCE</h4>
                                <span class="designation"></span>
                            </div>
                        </div>
                ...
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-lg-12 text-center">
                            <a href="/" class="footer-logo"><img src="assets/images/logo.png" alt="image"></a>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-6 text-md-left text-center">
                            <p>© 2022 <a href="/?a=home" class="base--color"> Hybridminers</a>. All rights reserved</p>
                        </div>
                        <div class="col-md-6">
                            <ul class="social-link-list d-flex flex-wrap justify-content-md-end justify-content-center">
                                <li><a href="/" data-toggle="tooltip" data-placement="top" title="facebook"><i class="lab la-facebook-f"></i></a></li>
                                <li><a href="/" data-toggle="tooltip" data-placement="top" title="twitter"><i class="lab la-twitter"></i></a></li>
                                <li><a href="/" data-toggle="tooltip" data-placement="top" title="pinterest"><i class="lab la-pinterest-p"></i></a></li>
                                <li><a href="/" data-toggle="tooltip" data-placement="top" title="pinterest"><i class="lab la-pinterest-in"></i></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
