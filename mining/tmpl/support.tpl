        ...
        <div class="contact-wrapper">
          <div class="row">
            ...
            <div class="col-lg-6 contact-form-wrapper">
              ...
              <form class="contact-form mt-4"><input type="hidden" name="form_id" value=""><input type="hidden" name="form_token" value="">
                <div class="form-row">
            ...
            <div class="row mb-none-30">
              ...
              <div class="col-md-4 col-sm-6 mb-30">
                <div class="contact-item">
                  ...
                  <div class="mt-4">
                    <p><a href="#"><span>support@hybridminers.io</span></a></p>
                     </div>
                </div><!-- contact-item end -->
              </div>
              <div class="col-md-4 col-sm-6 mb-30">
                <div class="contact-item">
                  ...
                  <div class="mt-4">
                    <p>#65 Street, Melborne 1265,UK</p>
                  </div>
                </div><!-- contact-item end -->
              </div>
            </div>
                        ...
                        <div class="subscribe-wrapper bg_img" data-background="assets/images/bg/bg-5.jpg">
                            <div class="row align-items-center">
                                ...
                                <div class="col-lg-7 mt-lg-0 mt-4">
                                    <form class="subscribe-form"><input type="hidden" name="form_id" value="16619005442469"><input type="hidden" name="form_token" value="376ac3b411d2387b972a484afd57940e">
