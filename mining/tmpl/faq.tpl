                        ...
                        <div class="subscribe-wrapper bg_img" data-background="assets/images/bg/bg-5.jpg">
                            <div class="row align-items-center">
                                ...
                                <div class="col-lg-7 mt-lg-0 mt-4">
                                    <form class="subscribe-form"><input type="hidden" name="form_id" value="16619003961169"><input type="hidden" name="form_token" value="07fdbcccef32a016b1978ab0f8e668f0">
