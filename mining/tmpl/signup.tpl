              ...
              <div class="account-card__body">
                ...
                <form class="mt-4">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Enter full name" name=fullname value="{$frm.fullname|escape:html}">
                  </div>
                  <div class="form-group">
                    <label>Username</label>
                    <input type="text" class="form-control" placeholder="Enter username" name=username value="{$frm.username|escape:html}">
                  </div>
                  <div class="form-group">
                    <label>Email Address</label>
                    <input type="email" class="form-control" placeholder="Enter email address" name=email value="{$frm.email|escape:html}">
                  </div>
                  <div class="form-group">
                    <label>Repeat Email Address</label>
                    <input type="email" class="form-control" placeholder="Enter email address" name=email1 class=inpts  value="{$frm.email1|escape:html}">
                  </div>
                  <div class="form-group">
                    <label>Password</label>
                    <input type="password" class="form-control" placeholder="Enter password" name=password class=inpts  value="{$frm.password|escape:html}">
                  </div>
                  <div class="form-group">
                    <label>Repeat Password</label>
                    <input type="password" class="form-control" placeholder="Repeat password" name=password2 class=inpts  value="{$frm.password2|escape:html}">
                  </div>
                  <div class="form-row">
                    <div class="col-sm-6">
                      <div class="form-group form-check">
                        <input type=checkbox name=agree value=1 {if $frm.agree}checked{/if}>
                        <label class="form-check-label">I agree with <a href="{"?a=rules"|encurl}">Terms and conditions</a></label>
                      </div>
                    </div>
