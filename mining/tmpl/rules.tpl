    ...
    <div class="page-wrapper">
                            ...
                            <ul class="navbar-nav main-menu m-auto">
                              ...
                              <div class="nav-right">
                                <ul class="account-menu ml-3">
                                    <li class="icon">
                                      <div id="ytWidget">
      </div><script src="https://translate.yandex.net/website-widget/v1/widget.js?widgetId=ytWidget&pageLang=en&widgetTheme=light&autoMode=false" type="text/javascript"></script>
        </div></li>
                                </ul>
        ...
        <section class="inner-hero bg_img" data-background="assets/images/bg/bg-1.jpg">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
                        <h2 class="page-title">Rules & Agreements.</h2>
                ...
                <div class="row">
                    <div class="col-lg-6 offset-lg-6">
                        <div class="about-content">
                            <h2 class="section-title mb-3"><span class="font-weight-normal">Rules</span> <b class="base--color">& Agreements.</b></h2>
                            <p>
...
You agree to be of legal age in your country to partake in this program, and in all the cases your minimal age must be 18 years.<br><br>
 ...
 Hybridminers is not available to the general public and is opened only to the qualified members of  Hybridminers, the use of this site is restricted to our members and to individuals personally invited by them. Every deposit is considered to be a private transaction between the  Hybridminers and its Member.<br><br>
	
As a private transaction, this program is exempt from the Uk Securities Act of 1933, the Uk Securities Exchange Act of 1934 and the UK Investment Company Act of 1940 and all other rules, regulations and amendments thereof. We are not FDIC insured. We are not a licensed bank or a security firm.<br><br>
  You agree that all information, communications, materials coming from  Hybridminers 
...
All the data giving by a member to  Hybridminers will be only privately used and not disclosed to any third parties.  Hybridminers is not responsible or liable for any loss of data.<br><br>
 ...
 Hybridminers is not responsible or liable for any damages, losses and costs resulting from any violation of the conditions and terms and/or use of our website by a member. You guarantee to  Hybridminers that you will not use this site in any illegal way and you agree to respect your local, national and international laws.<br><br>
...
We will not tolerate SPAM or any type of UCE in this program. SPAM violators will be immediately and permanently removed from the program.<br><br>
 ...
 Hybridminers reserves the right to accept or decline any member for membership without explanation.<br><br>
                        ...
                        <div class="subscribe-wrapper bg_img" data-background="assets/images/bg/bg-5.jpg">
                            <div class="row align-items-center">
                                ...
                                <div class="col-lg-7 mt-lg-0 mt-4">
                                    <form class="subscribe-form"><input type="hidden" name="form_id" value="16619004319101"><input type="hidden" name="form_token" value="">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-6 text-md-left text-center">
                            <p>© 2022 <a href="/" class="base--color"> Hybridminers</a>. All rights reserved</p>
                        </div>
                        <div class="col-md-6">
